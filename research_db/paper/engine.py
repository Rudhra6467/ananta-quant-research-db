...
class PaperLedger:
    def __init__(self) -> None:
        ...
        self.decisions = []
    def decide(self, profile: str, action: str, knowledge_time: str, reason: str, query: str | None = None):
        ...
        row = {"profile": profile, "action": action, "knowledge_time": knowledge_time, "reason": reason, "query": query, "capital": 0}
